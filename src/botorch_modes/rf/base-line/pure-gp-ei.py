...
def call_external(X, num_trial, num_param, dataset, node_id):
    ...
    for i in range (0, num_trial):
        ...
        commands = 'python3 /home/jjshi/modes/botorch/' + folder_name + '/call_ml_idv.py' + ' -i ' + str(
...
def generate_initial_data(dataset, node_id):
    ...
    exact_obj = call_external(train_x, 20, 7, dataset, node_id)
...
def main(argv):
    ...
    for trial in range(1, N_TRIALS + 1):
        ...
        csv_file_name = '/home/jjshi/modes/botorch/' + folder_name + '/base-line/hp-gp-ei-dataset-' + str(
            dataset) + '-node-' + str((node_id+1)) + '-trail' + str(trial) + '.csv'
