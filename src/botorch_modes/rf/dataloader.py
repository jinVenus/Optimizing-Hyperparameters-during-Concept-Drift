...
def load_data(datasets_num, type):
    ...
    # datasets = ['alldata', 'nddata', 'ovdata', 'unddata']
    datasets = ['MNIST', 'MNIST_cd', 'MNIST_mix', 'MNIST_28', 'MNIST_cd_82', 'MNIST_2882', 'MNIST_cd_fr15',
                'MNIST_fr15_mix', 'MNIST_cd_fr5', "MNIST_fr5_mix", 'MNIST_010', 'MNIST_cd_100', 'MNIST_010100',
                'dynamic', 'test', 'detect']
    ...
    if dataset == 'MNIST':
    ...
    elif dataset == 'MNIST_010':
        data = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_cd_010.csv', sep=',', header=None)
        X_train = data.iloc[:, 1:]
        y_train = data.iloc[:, 0]
        X_train = np.array(X_train)
        y_train = np.array(y_train)
    ...
    elif dataset == 'MNIST_cd_100':
        data = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_cd_100.csv', sep=',', header=None)
        X_train = data.iloc[:, 1:]
        y_train = data.iloc[:, 0]
        X_train = np.array(X_train)
        y_train = np.array(y_train)
    ...
    elif dataset == 'MNIST_010100':
        data1 = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_cd_010.csv', sep=',', header=None)

        data2 = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_cd_100.csv', sep=',', header=None)
        ...
        if type == 'eval':
            X_train1 = X_train1.reshape(len(data1), -1)
            X_train2 = X_train2.reshape(len(data2), -1)
            X_val = X_train2[25000:]
            X_train = X_train1[:20000]
            y_val = y_train2[25000:]
            y_train = y_train1[:20000]

        if type == 'test':
            X_train1 = X_train1.reshape(len(data1), -1)
            X_train2 = X_train2.reshape(len(data2), -1)
            X_val = X_train2[20000:25000]
            X_train = X_train1[:20000]
            y_val = y_train2[20000:25000]
            y_train = y_train1[:20000]

    elif dataset == 'dynamic':
        data1 = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_dynamic.csv', sep=',', header=None)
        data2 = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_cd_fr15.csv', sep=',', header=None)
        data3 = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_train.csv', sep=',', header=None)
        ...
        X_train3 = data3.iloc[:, 1:]
        y_train3 = data3.iloc[:, 0]
        ...
        if type == 'eval':
            X_train1 = X_train1.reshape(len(data1), -1)
            X_train2 = X_train2.reshape(len(data2), -1)
            X_train3 = X_train3.reshape(60000, -1)
            X_val = X_train1[50000:]
            X_train = X_train1[:40000]
        ...
        if type == 'test':
            X_train1 = X_train1.reshape(len(data1), -1)
            X_train2 = X_train2.reshape(len(data2), -1)
            X_val = X_train1[40000:]
            X_train = X_train1[:40000]
            y_val = y_train1[40000:]
            y_train = y_train1[:40000]
        ...
        if type == 'eval':
            ...
            X_val = X_train1[50000:]
            X_train = X_train2[:40000]
            y_val = y_train1[50000:]
            y_train = y_train2[:40000]

        if type == 'test':
            X_train = X_train1.reshape(60000, -1)
        ...
        data1 = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_todetect_train_shuffle.csv', sep=',', header=None)
        data2 = pd.read_csv('E:\\ML\\Hiwi\\data\\MNIST\\raw\\mnist_cd_fr0.csv', sep=',', header=None)

        X_train1 = data1.iloc[:, 2:]
        y_train1 = data1.iloc[:, 0]
        X_train1 = np.array(X_train1)
        y_train1 = np.array(y_train1)
