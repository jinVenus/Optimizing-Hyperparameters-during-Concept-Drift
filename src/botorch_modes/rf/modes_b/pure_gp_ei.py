...
from Hiwi.src.algorithms.Adjust_window_size import Aj_Win
...
def main(argv):
    ...
    for trial in range(1, N_TRIALS + 1):
        ...
        for iteration in range(1, N_BATCH + 1):
            ...
            if count == new:
                ...
                csv_file_name = 'E:\\ML\\Hiwi\\results\\' + 'hp_gp_ei_rf_dataset_' + str(
                    dataset) + '_trail' + str(trial) + '_cd_' + str(win) + '.csv'
                ...
                old, new, pfr = Aj_Win(pre_fr, data.iloc[:, 1:])
                pre_fr = pfr
                if not old == 0:
                    train_x_ei = train_x_ei[(50 - old):]
                    train_obj_ei = train_obj_ei[(50 - old):]
        ...
        #
        # # csv_file_name = 'E:\\ML\\Hiwi\\results\\' + 'hp_gp_ei_rf_dataset_' + str(
        # #     dataset) + '_fr' + str(fr) + '_trail' + str(trial) + '.csv'
        #
        # csv_file_name = 'E:\\ML\\Hiwi\\results\\' + 'hp_gp_ei_rf_dataset_' + str(
        #     dataset) + 'detect_only9' + '_trail' + str(trial) + '.csv'
        #
        # with open(csv_file_name, 'w') as csvFile:
        #     writer = csv.writer(csvFile)
