...
def main(argv):
    ...
    for i in range (1, 11):
        ...
        for node_id in range(0, num_nodes):
            ...
            commands_predicted = 'ssh jjshi@ls12-epyc0 python3 /home/jjshi/modes/botorch/' + folder_name + '/eval-ml-idv.py' + ' -i ' + str(predicted_hp) + ' -o ' + str(csv_predicted_name) + ' -d ' + str(node_id) + ' -s ' + str(datasets_number) + ' &'
            commands_observed = 'ssh jjshi@ls12-epyc0 python3 /home/jjshi/modes/botorch/' + folder_name + '/eval-ml-idv.py' + ' -i ' + str(observed_hp) + ' -o ' + str(csv_observed_name) + ' -d ' + str(node_id) + ' -s ' + str(datasets_number) + ' &'
