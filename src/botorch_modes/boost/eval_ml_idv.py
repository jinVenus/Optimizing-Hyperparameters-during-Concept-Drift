...
import sys
import getopt
from Hiwi.src.algorithms.botorch_modes.boost.adaboost_func_eval import adaboost_model_test
...
def main(argv):
    ...
    train_time, val_acc = adaboost_model_test(hp_params, datasets_number)
