...
def main(argv):
    folder_name = 'adaboost_mnist'
    method_name = 'gp_ei_ada'
    num_nodes = 1
    num_params = 6
    win_num = 9
    datasets_number = 14
    ...
    for i in range(1, 2):
        ...
        commands_predicted = 'python E:\\ML\\Hiwi\\src\\algorithms\\botorch_modes\\boost\\eval_ml_idv.py' + ' -i ' + str(
            predicted_hp) + ' -o ' + str(csv_predicted_name_local) + ' -s ' + str(datasets_number) + ' &'
        commands_observed = 'python E:\\ML\\Hiwi\\src\\algorithms\\botorch_modes\\boost\\eval_ml_idv.py' + ' -i ' + str(
