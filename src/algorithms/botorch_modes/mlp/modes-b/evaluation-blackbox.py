...
def main(argv):
    ...
    result_name = 'E:\\ML\\Hiwi\\results\\' + folder_name + '-dataset-' + str(datasets_number) + '.csv'
    ...
    for i in range(1, 11):
        hp_file_name = 'E:\\ML\\Hiwi\\results\\' + 'hp-' + method_name + '-dataset-' + str(
            datasets_number) + '-trail' + str(i) + '.csv'
