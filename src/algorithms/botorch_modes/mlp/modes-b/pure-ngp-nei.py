...
def generate_initial_data(dataset):
    ...
    train_x = generate_rand(36, 5)
    exact_obj = call_external(train_x, 36, 5, dataset).unsqueeze(-1)
...
BATCH_SIZE = 1
bounds = torch.tensor([[0, 10, 0, 2, 1, 0.01, 0.01, 0.01, 0.01], [14.99, 150.99, 3.99, 5, 4, 1, 1, 1, 1]], device=device, dtype=dtype)
