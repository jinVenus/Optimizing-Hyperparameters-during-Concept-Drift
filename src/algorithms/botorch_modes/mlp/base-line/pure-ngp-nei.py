...
def generate_initial_data(dataset, node_id):
    ...
    exact_obj = call_external(train_x, 20, 5, dataset, node_id).unsqueeze(-1)
...
# average over multiple trials
	...
	# fit the posrteriormean model
        ...
        csv_file_name = '/home/junjie/modes/botorch/' + folder_name + '/base-line/hp-ngp-nei-dataset-' + str(
