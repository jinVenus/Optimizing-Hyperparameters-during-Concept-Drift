...
import sys
import getopt
from Hiwi.src.algorithms.botorch_modes.rf.rf_func_eval import rf_model_test
...
def main(argv):
    ...
    train_time, val_acc = rf_model_test(hp_params, datasets_number)
