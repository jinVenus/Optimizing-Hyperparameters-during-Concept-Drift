...
def rf_model(hyper_vector, datanum):
    # pool of hypers
    ...
    X_train, y_train, X_val, y_val = load_data(datanum, 'test')
...
# hyper_vector = [int(61.03794141), int(1.66359048), int(16.621841), int(14.05320706), int(13.98009677), int(1.00152747),
#    int(0.96022582)]
# time, scores = rf_model(hyper_vector, 0, 0)
# print(time, scores)
